<?php
  ...
  $query="SELECT * FROM `wellness` where (status='Reported' and risk='High') order by id desc";
       ...
       <td><?php echo $rows['phone'];?></td>
        <td><?php echo $rows['risk'];?></td>
         ...
         <td><button class="btn btn-warning" style="border-radius: 50px;height: 20px; padding: 1%;" ><?php echo $rows['status'];?></button></td>
           <td><button type="button" class="btn btn-primary"><a href="reviewer/hospitalindex.php?id=<?php echo $rows['infowellsec'];?>" style="color: white;"> Review</a></button></td>
  </tr>
</tbody>
<?php
}
