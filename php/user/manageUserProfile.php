...
function getUserDataFromRequest(){
    ...
    $userData->category = htmlentities($_POST['category'], ENT_QUOTES);
    $userData->address = htmlentities($_POST['address'], ENT_QUOTES);
    $userData->code = htmlentities($_POST['code'], ENT_QUOTES);
    $userData->city = htmlentities($_POST['city'], ENT_QUOTES);
    $userData->team = implode(",",$_POST['team']);
     $userData->department = htmlentities($_POST['department'], ENT_QUOTES); 
