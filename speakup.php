...
<select id="dist" name="dist" class="form-control" onchange="showdistrict()"  style="border-color:#B8B8BB;background:transparent;">
       ...
       <option>Select your District</option>
         ...
         <input type="radio" name="udetails" value="Anonymous" id="Anonymous" checked="checked">Keen to be Anonymous
         <span></span>
       </label>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
         <label class="kt-radio kt-radio--solid kt-radio--success" style="color: black; font-size: 14px;">
             <input type="radio" name="udetails" value="disclose" id="disclose"> Keen to disclose
...
<select class="form-control kt-select2" id="kt_select2_3" name="param" multiple="multiple" style="width: 100%;" placeholder="select">
        ...
        <option value="WORKSTRESS">WORK STRESS</option>
          ...
          <div class="kt-wizard-v3__content" data-ktwizard-type="step-content">
		   ...
		   <span id="result"></span>
            <div class="kt-heading kt-heading--md">Review your Details and Submit</div>
			 ...
			 <p id="mem" style="font-size:17px; font-weight: 400"></p>
			</div>
			 <div style=" display: flex; align-items: center;">
				<p style="font-size: 20px; font-weight: 500">District : </p>&nbsp;<p id="dist1" style="font-size:17px; font-weight: 400"></p>
			</div>
			<div style=" display: flex; align-items: center;">
				<p style="font-size: 20px; font-weight: 500">People living in home :</p>&nbsp;<p id="nmem" style="font-size:17px; font-weight: 400"></p>
		    </div>
              <div class="kt-form__section kt-form__section--first">
          ...
          <div class="kt-form__actions">
            ...
            <button class="btn btn-brand btn-md btn-tall btn-wide kt-font-bold kt-font-transform-u" data-ktwizard-type="action-next" onclick="showvalue1();showvalue2()">
              Next Step
            </button >
          </div>
          <!--end: Form Actions -->
...
<script type="text/javascript">
            $(document).ready(function () {
                $("input[type='radio']").on('change', function () {
                    var selectedValue = $("input[name='udetails']:checked").val()
                    if (selectedValue=="Anonymous") {
						document.getElementById('mem').innerHTML = selectedValue;
                    }
                });
            });
</script>
...
<script type="text/javascript">
            $(document).ready(function () {
                $("input[type='radio']").on('change', function () {
                    var selectedValue = $("input[name='family']:checked").val();
					 if (selectedValue) {
						document.getElementById('nmem').innerHTML = selectedValue;
                    }
...
<script>
	function checkk(kt_slider_1)
	{
		  if(kt_slider_1>=0 && kt_slider_1<=3)
		  {
			  return "Low";
		  }
		  else if(kt_slider_1>3 && kt_slider_1<7)
		  {
			  return "Medium";
		  }
		  else
...
<script type="text/javascript">
  ...
  document.getElementById('res1').innerHTML=checkk(kt_slider_1);
  var kt_slider_2 = document.getElementById('kt_slider_2').value;
  document.getElementById('res2').innerHTML = checkk(kt_slider_2);
  var kt_slider_3 = document.getElementById('kt_slider_3').value;
  document.getElementById('res3').innerHTML = checkk(kt_slider_3);
  var kt_slider_4 = document.getElementById('kt_slider_4').value;
  document.getElementById('res4').innerHTML = checkk(kt_slider_4);
  var kt_slider_5 = document.getElementById('kt_slider_5').value;
  document.getElementById('res5').innerHTML = checkk(kt_slider_5);
  var kt_slider_6 = document.getElementById('kt_slider_6').value;
  document.getElementById('res6').innerHTML =checkk( kt_slider_6);
  var kt_slider_7 = document.getElementById('kt_slider_7').value;
  document.getElementById('res7').innerHTML =checkk( kt_slider_7);
  var kt_slider_8 = document.getElementById('kt_slider_8').value;
  document.getElementById('res8').innerHTML = checkk(kt_slider_8);
  var kt_slider_9 = document.getElementById('kt_slider_9').value;
  document.getElementById('res9').innerHTML = checkk(kt_slider_9);
  var kt_slider_10 = document.getElementById('kt_slider_10').value;
  document.getElementById('res10').innerHTML = checkk(kt_slider_10);
  var kt_slider_11 = document.getElementById('kt_slider_11').value;
  document.getElementById('res11').innerHTML = checkk(kt_slider_11);
  var kt_slider_12 = document.getElementById('kt_slider_12').value;
  document.getElementById('res12').innerHTML = checkk(kt_slider_12);
  var kt_slider_13 = document.getElementById('kt_slider_13').value;
  document.getElementById('res13').innerHTML = checkk(kt_slider_13);
  var kt_slider_14 = document.getElementById('kt_slider_14').value;
  document.getElementById('res14').innerHTML = checkk(kt_slider_14);
  var kt_slider_15 = document.getElementById('kt_slider_15').value;
  document.getElementById('res15').innerHTML = checkk(kt_slider_15);
  var kt_slider_16 = document.getElementById('kt_slider_16').value;
  document.getElementById('res16').innerHTML = checkk(kt_slider_16);
  var kt_slider_17 = document.getElementById('kt_slider_17').value;
  document.getElementById('res17').innerHTML = checkk(kt_slider_17);
  var kt_slider_18 = document.getElementById('kt_slider_18').value;
  document.getElementById('res18').innerHTML = checkk(kt_slider_18);
  var kt_slider_19 = document.getElementById('kt_slider_19').value;
  document.getElementById('res19').innerHTML = checkk(kt_slider_19);
  var kt_slider_20 = document.getElementById('kt_slider_20').value;
  document.getElementById('res20').innerHTML = checkk(kt_slider_20);
  var kt_slider_21 = document.getElementById('kt_slider_21').value;
  document.getElementById('res21').innerHTML = checkk(kt_slider_21);
  var kt_slider_22 = document.getElementById('kt_slider_22').value;
  document.getElementById('res22').innerHTML = checkk(kt_slider_22);
  var kt_slider_23 = document.getElementById('kt_slider_23').value;
  document.getElementById('res23').innerHTML = checkk(kt_slider_23);
  var kt_slider_24 = document.getElementById('kt_slider_24').value;
  document.getElementById('res24').innerHTML = checkk(kt_slider_24);
  var kt_slider_25 = document.getElementById('kt_slider_25').value;
  document.getElementById('res25').innerHTML = checkk(kt_slider_25);
  var kt_slider_26 = document.getElementById('kt_slider_26').value;
  document.getElementById('res26').innerHTML = checkk(kt_slider_26);
  var kt_slider_27 = document.getElementById('kt_slider_27').value;
  document.getElementById('res27').innerHTML = checkk(kt_slider_27);
  var kt_slider_28 = document.getElementById('kt_slider_28').value;
  document.getElementById('res28').innerHTML = checkk(kt_slider_28);
  var kt_slider_29 = document.getElementById('kt_slider_29').value;
  document.getElementById('res29').innerHTML = checkk(kt_slider_29);
  var kt_slider_30 = document.getElementById('kt_slider_30').value;
  document.getElementById('res30').innerHTML = checkk(kt_slider_30);
  var kt_slider_31 = document.getElementById('kt_slider_31').value;
  document.getElementById('res31').innerHTML = checkk(kt_slider_31);
  var kt_slider_32 = document.getElementById('kt_slider_32').value;
  document.getElementById('res32').innerHTML = checkk(kt_slider_32);
  var kt_slider_33 = document.getElementById('kt_slider_33').value;
  document.getElementById('res33').innerHTML = checkk(kt_slider_33);
  var kt_slider_34 = document.getElementById('kt_slider_34').value;
  document.getElementById('res34').innerHTML = checkk(kt_slider_34);
  var kt_slider_35 = document.getElementById('kt_slider_35').value;
  document.getElementById('res35').innerHTML = checkk(kt_slider_35);
  var kt_slider_36 = document.getElementById('kt_slider_36').value;
  document.getElementById('res36').innerHTML = checkk(kt_slider_36);
  var kt_slider_37 = document.getElementById('kt_slider_37').value;
  document.getElementById('res37').innerHTML = checkk(kt_slider_37);
  var kt_slider_38 = document.getElementById('kt_slider_38').value;
  document.getElementById('res38').innerHTML = checkk(kt_slider_38);
  var kt_slider_39 = document.getElementById('kt_slider_39').value;
  document.getElementById('res39').innerHTML = checkk(kt_slider_39);
  var kt_slider_40 = document.getElementById('kt_slider_40').value;
  document.getElementById('res40').innerHTML = checkk(kt_slider_40);
  var kt_slider_41 = document.getElementById('kt_slider_41').value;
  document.getElementById('res41').innerHTML = checkk(kt_slider_41);
  var kt_slider_42 = document.getElementById('kt_slider_42').value;
  document.getElementById('res42').innerHTML = checkk(kt_slider_42);
