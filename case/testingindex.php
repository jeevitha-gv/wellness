...
<div class="container">
  <a data-toggle="collapse" data-target="#data" style="font-size: 16px;"><button class="flaticon2-arrow" style="border-radius: 25px; background-color: #034ea2; color: #ffffff;margin-top: %;">  History</button></a>
</div><br>
</form>
