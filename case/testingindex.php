   ...
   if(isset($_POST['submit']))
    {
     ...
     $WBU=$_POST['WBU'];
      $status="Reported";
  $sql1="UPDATE `wellness` SET Synopsis='$Synopsis',WBU='$WBU',status='$status' WHERE id=$id";
...
<div class="container">
  <a data-toggle="collapse" data-target="#data" style="font-size: 16px;"><button class="flaticon2-arrow" style="border-radius: 25px; background-color: #86346C; color: #ffffff;margin-top: %;">  History</button></a>
</div><br>
</form>
