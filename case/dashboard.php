<?php
   session_start();
    ...
    $result2 = mysqli_query($link,$sql2);
     ...
     $sql3 = "SELECT count(status) as count FROM `wellness` WHERE status='reinvestigate' ORDER BY id DESC";
...
<div class="row">
 ...
 if($rows=mysqli_fetch_assoc($result)) {
  ?>
      <span class="kt-widget17__subtitle" style="font-weight: normal; font-size: 16px;">
          New Case
      </span>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;      <span class="kt-widget17__subtitle" style="font-size: 20px;color: white;"><?php echo $rows['count'];?></span>
      <?php
    }
    ?>
    </label>
 ...
 if($rows=mysqli_fetch_assoc($result1)) {
  ?>
    ...
    &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
      <span class="kt-widget17__subtitle" style="font-size: 20px;color: white"><?php echo $rows['count'];?></span>
      <?php
    }
    ?>
    </label>
...
.topright:hover {color: red;}
  ...
  Highcharts.chart('chartdiv1', {
    ...
    // create data
    var data = [
      {x: "march", y: "High", heat: 15},
      {x: "may", y: "High", heat: 17},
      {x: "june", y: "High", heat: 21},
      {x: "march", y: "Medium", heat: 34},
      {x: "may", y: "Medium", heat: 33},
      {x: "june", y: "Medium", heat: 32},
      {x: "march", y: "Low", heat: 51},
      {x: "may", y: "Low", heat: 50},
      {x: "june", y: "Low", heat: 47}
    ];
    ...
    // set the chart title
    chart.title("Wellness Heat chat");
