<?php
    ...
    $query = "SELECT * FROM `wellness` WHERE (status='created' and risk='High') or (status='Reported' and risk='High') or (status='reinvestigate' and risk='High') ORDER BY id DESC";
   ...
   <td><?php echo $rows['createat'];?></td>
     ...
     <td><?php echo $rows['name'];?></td>
      <td><?php echo $rows['phone'];?></td>
       <td><button class="btn btn-danger" style="border-radius: 50px;height: 20px; padding: 1%;" ><?php echo $rows['risk'];?></button></td>
      <td>
      <?php
