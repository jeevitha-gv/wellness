...
<!-- <div id="kt_header" class="kt-header kt-grid__item  kt-header--fixed "  data-ktheader-minimize="on"  style=" background-color: #808080;height: 40px;">
  ...
  <div class="kt-header__topbar-item dropdown" style="margin-bottom: 20px;">
    ...
    <button class="btn btn-success"  onclick="document.getElementById('id01').style.display='block'" style="background: transparent;border-radius: 26px;border:2px solid #88c3ea;font-weight: 500;color: #48465b;">ADMIN</button>
              ...
              <span class="kt-header__topbar-icon">
                  <button type="button" class="btn btn-success" title="Admin"  onclick="document.getElementById('id01').style.display='block'"style="background: white;border-radius: 26px;border:2px solid #afd135;font-weight: 500;color: #48465b;">Admin</button>&nbsp;
 ...
 <img src="img_avatar2.png" alt="Avatar" class="avatar">
    ...
    <div class="container" style="line-height:350%;color:#525150;">
      <label for="email" style=" font-size: 1.2rem;"  i class="fa fa-file">&nbsp;&nbsp;<b>SPEAK NUMBER:</b></label>
       <input class="form-control" type="text"  placeholder="case/info number" name="infowellsec"><br>

      <label for="password" style=" font-size: 1.2rem;color:#525150;"  i class="fa fa-key">&nbsp;&nbsp;<b>SECRETKEY:</b></label>
    <input class="form-control" type="text" placeholder="infowellkey" name="infowellkey" id="infowellkey"><br><br>
        <center>
      <input type="submit" name="submit" style="background: #afd135;border-radius: 8px;width:40%;height:10%;border:2px solid  #afd135;font-weight: 500;color: white;">
      </center>
