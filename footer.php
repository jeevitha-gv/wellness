...
<div class="kt-footer  kt-footer--extended  kt-grid__item" id="kt_footer" style="background-color: white;height:50px;">
 ...
 -->
       <!--          </div>  
           ...
           <!--     <div class="col-lg-4">
            <div  class="kt-footer__section">
              <h3 class="kt-footer__title">Follow Us</h3>
              <div class="kt-footer__content">
                <div class="kt-footer__nav">
    ...
    <div class="kt-container ">
      <div class="kt-footer__wrapper">
        ...
        <!--   <a href="demo2/index.html">
          ...
          The WellnessSpeak  is a platform which aims to record your Emotional Wellness state and display results based on the answer to the questionnaire. <a style="color: white;" onclick="document.getElementById('id03').style.display='block'">Click More</a>
...
<div class="kt-footer__content">
           ...
           <!--  <a href="#" class="btn btn-google btn-icon soc" title="Follow on Google" style="color: white;"><i class="socicon-google"></i></a>&nbsp; -->
            <a href="https://www.instagram.com/CoronaSpeak/" class="btn btn-instagram btn-icon soc" title="Follow on Instagram" style="color: white;"><i class="socicon-instagram"></i></a>&nbsp;
...
<!-- end:: Footer -->     </div>
  ...
  <form class="modal-content kt-container" action="" method="post" style="border:1.5px solid #7A7777;">
   <div class="imgcontainer">
      <span onclick="document.getElementById('id03').style.display='none'" class="close" title="">&times;</span>
      
    </div>

    <div style="line-height:300%;color:#525150;border-color:#B4B8B8;padding:26px;">
     <h3>Wellness Speak Disclaimer</h3><br>

We are here to help. 
First off, this is a secure consulting room and your identity is protected. We use the latest technology of Block Chain to provide this completely anonymous way of communicating. <span id="dots">....</span><span id="more">
Neither your name, nor your telephone number is captured unless you voluntarily provide it. Please save the Speak number and key and should you need to visit us again, you may use them to log in to view your previous report with us.  There will be no trace of your contact with us other than this speak number. Should you choose to use the “Chat to a Wellness Expert” facility, it will connect to our telegram group from where a realtime counsellor team  will be available on call.  How may we help you?</span>
<span onclick="myFunction()" id="myBtn" style="color:#034ea2;">Read more</span>
